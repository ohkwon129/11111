...
<script>
$(function(){
	$('#buttonChampAdd').click(function(){
		document.frm.submit();
	});
	$('#buttonChampCancel').click(function(){
...
<div id = "wrapper">
	...
	<div id = "events">
		<div id = "eventAddArea">
			...
			<div id="eventInfo">
				<form id = "eventInfoFrm" action="<%=contextPath%>/jiutopia/championshipAdd.do" method="get" name="frm">
					대회 명 : <input type ="text" value="" id ="eventTitle" name = "eventTitle"><br />
					장소: <input type ="text" value="" id ="eventLoc" name = "eventLoc"><br />  
					체급 : <input type ="text" value="" id ="eventClass" name = "eventClass"><br />
					시작 날짜 : <input type ="text" value="" id ="eventStart" name = "eventStart"><br />
					종료 날짜 : <input type ="text" value=""id ="eventEnd" name = "eventEnd"><br>
					소 개 : <textarea rows="8" cols ="50" id ="eventCont" name = "eventCont" ></textarea><br>
	...
	<div id = "buttons">
			<br/>
			<input type = "button" id="buttonChampAdd"  value="추가">
			<input type = "button" id="buttonChampCancel" value="취소">
		</div>		
<br>
