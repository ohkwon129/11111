...
<header id="topMain">
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	...
	<h1>Log In</h1>
<div id = "login">
	<form name="frm" action="<%=contextPath %>/jiutopia/popLogin.do">
		아이디 &nbsp; &nbsp;<input type="text" name="id" id="id" placeholder="아이디를 입력하시오" required /><br /> 
		비밀번호 <input type="password" name="pwd" id="pwd" placeholder="비밀번호를 입력하시오" required /><br />
		<br /> 
		<input type="button" id="login" value="로그인" onclick="btnClose()"/>
